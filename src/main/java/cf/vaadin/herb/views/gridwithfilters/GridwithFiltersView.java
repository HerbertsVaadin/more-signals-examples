package cf.vaadin.herb.views.gridwithfilters;

import cf.vaadin.herb.data.SamplePerson;
import cf.vaadin.herb.services.SamplePersonService;
...
@Menu(order = 15, icon = LineAwesomeIconUrl.FILTER_SOLID)
@Uses(Icon.class)
