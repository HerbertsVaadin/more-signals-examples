...
- **`cf.vaadin.herb.base`**: Reusable components and base classes for all features
...
- **`cf.vaadin.herb.examplefeature`**: Example feature demonstrating the structure
...
1. Create a new package under `cf.vaadin.herb` (e.g., `cf.vaadin.herb.myfeature`)
